...
const data = [
  {
    id: 0,
    name: 'Pope Francis',
    description: 'He’s talking tough on clergy sexual abuse, or is he just another pervert protector? or a true pedophile punishing pontiff?',
    category: 'religion',
...
// indexes
const indexes = data.map(d => d.id);

redis.sadd('celebrities', ...indexes);
